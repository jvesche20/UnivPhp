...
if(isset($_POST['submit'])){
    ...
    if(empty($data_missing)){
        ...
        mysqli_stmt_bind_param($stmt, "ssssssisssdi", $f_name,
                               $l_name, $email, $street, $city,
                               $state, $zip, $phone, $b_date,
                               $sex, $lunch, $student_id);
...
<form action="http://localhost/University/student/studentadded.php" method="post">
    
    <b>Add a New Professor</b>
